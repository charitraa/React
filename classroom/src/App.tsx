        ...
        <div className="relative isolate px-6 pt-14 lg:px-8 text-white"
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="text-center">
              <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">Discover GizmoMax
              </h1>
              <p className="mt-6 text-lg leading-8 text-white">At GizmoHub, we are committed to innovating the future of
                technology. Our mission is to create cutting-edge gadgets that
                enhance everyday life. With a passion form excellence and a dedication to quality, GizmoHub strives to push
                the
                boundaries of what's possible in the tech world.s</p>
      ...
      <section id="contact" className="section">
        <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-2 text-lg leading-8 text-gray-600">Let's Connect</p>
          </div>
          <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              <div>
                <label form="first-name" className="block text-sm font-semibold leading-6 text-gray-900">First name</label>
              ...
              <div>
                <label form="last-name" className="block text-sm font-semibold leading-6 text-gray-900">Last name</label>
                <div className="mt-2.5">
              ...
              <div className="sm:col-span-2">
                <label form="company" className="block text-sm font-semibold leading-6 text-gray-900">Company</label>
                <div className="mt-2.5">
              ...
              <div className="sm:col-span-2">
                <label form="email" className="block text-sm font-semibold leading-6 text-gray-900">Email</label>
                <div className="mt-2.5">
              ...
              <div className="sm:col-span-2">
                <label form="phone-number" className="block text-sm font-semibold leading-6 text-gray-900">Phone number</label>
                <div className="relative mt-2.5">
                  <div className="absolute inset-y-0 left-0 flex items-center">
                    <label form="country" className="sr-only">Country</label>
              ...
              <div className="sm:col-span-2">
                <label form="message" className="block text-sm font-semibold leading-6 text-gray-900">Message</label>
                <div className="mt-2.5">
